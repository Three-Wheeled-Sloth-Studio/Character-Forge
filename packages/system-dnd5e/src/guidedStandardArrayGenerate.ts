...
import { guidedGenerateDnd5eFirstSlice, type GuidedChoiceProvenance } from "./guidedGenerate.js";
import type { Dnd5eAbilityScores } from "./nativeCharacter.js";
import type { GuidedDnd5eClassId, GuidedDnd5eSpeciesId } from "./srdCatalog.js";
...
export function guidedStandardArrayGenerateDnd5eFirstSlice(input: GuidedStandardArrayGenerateDnd5eInput): CharacterDocument {
  return guidedGenerateDnd5eFirstSlice({
    ...
    coreChoices: defaultGuidedDnd5eCoreChoices(input.classChoice.selectedId, "soldier", input.speciesChoice.selectedId),
    abilityMethod: { method: "standard-array", assignment: input.assignment },
