...
function poolDecision(label: string, acceptableIds: readonly string[]): GenerationDecision { return { stepId: `${label}.acceptable-pool`, answer: [...acceptableIds], rationale: `User-sticky acceptable ${label} options retained separately from the current direct choice.` }; }
