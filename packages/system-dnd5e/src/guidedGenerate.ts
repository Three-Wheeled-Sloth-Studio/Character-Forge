...
export interface GuidedGenerateDnd5eInput {
  name?: string;
  nameSelectionMode?: GuidedChoiceSelectionMode;
...
function nameRationale(input: GuidedGenerateDnd5eInput): string {
  if (input.nameSelectionMode === "random") return "Generated by the user's explicit randomize-name action.";
