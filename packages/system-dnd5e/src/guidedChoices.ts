...
export const DND5E_STANDARD_LANGUAGE_OPTIONS = [
  "common-sign-language", "draconic", "dwarvish", "elvish", "giant", "gnomish", "goblin", "halfling", "orc",
].map((id) => ({ id, label: labelId(id) })) as readonly Dnd5eChoiceOption[];

export const DND5E_BONUS_LANGUAGE_OPTIONS = [
  ...DND5E_STANDARD_LANGUAGE_OPTIONS,
  ...["abyssal", "celestial", "deep-speech", "druidic", "infernal", "primordial", "sylvan", "undercommon"]
    .map((id) => ({ id, label: labelId(id) })),
...
export const DND5E_FIGHTING_STYLE_OPTIONS = [
  ...
  { id: "great-weapon-fighting", label: "Great Weapon Fighting" },
...
export const DND5E_MONK_TOOL_OPTIONS = [
  ...ARTISAN_TOOL_IDS.map((id) => ({ id: `artisan-tools:${id}`, label: labelId(id) })),
  ...INSTRUMENT_IDS.map((id) => ({ id: `musical-instrument:${id}`, label: labelId(id) })),
] as readonly Dnd5eChoiceOption[];
...
export const DND5E_SKILLED_PROFICIENCY_OPTIONS = [
  ...
  { id: "forgery-kit", label: "Forgery Kit" },
  { id: "gaming-set:dice", label: "Gaming Set: Dice" },
  { id: "gaming-set:dragonchess", label: "Gaming Set: Dragonchess" },
  { id: "gaming-set:playing-cards", label: "Gaming Set: Playing Cards" },
  { id: "gaming-set:three-dragon-ante", label: "Gaming Set: Three-Dragon Ante" },
  { id: "herbalism-kit", label: "Herbalism Kit" },
  { id: "navigators-tools", label: "Navigator's Tools" },
  { id: "poisoners-kit", label: "Poisoner's Kit" },
  { id: "thieves-tools", label: "Thieves' Tools" },
] as readonly Dnd5eChoiceOption[];

export interface Dnd5eWeaponChoiceOption extends Dnd5eChoiceOption {
...
export const DND5E_WEAPON_OPTIONS: readonly Dnd5eWeaponChoiceOption[] = [
  weapon("club", "simple", false, true), weapon("dagger", "simple", true, true), weapon("greatclub", "simple"),
  weapon("handaxe", "simple", false, true), weapon("javelin", "simple"), weapon("light-hammer", "simple", false, true),
  weapon("mace", "simple"), weapon("quarterstaff", "simple"), weapon("sickle", "simple", false, true), weapon("spear", "simple"),
  weapon("dart", "simple", true), weapon("light-crossbow", "simple"), weapon("shortbow", "simple"), weapon("sling", "simple"),
  weapon("battleaxe", "martial"), weapon("flail", "martial"), weapon("glaive", "martial"), weapon("greataxe", "martial"),
  weapon("greatsword", "martial"), weapon("halberd", "martial"), weapon("lance", "martial"), weapon("longsword", "martial"),
  weapon("maul", "martial"), weapon("morningstar", "martial"), weapon("pike", "martial"), weapon("rapier", "martial", true),
  weapon("scimitar", "martial", true, true), weapon("shortsword", "martial", true, true), weapon("trident", "martial"),
  weapon("warhammer", "martial"), weapon("war-pick", "martial"), weapon("whip", "martial", true),
  weapon("blowgun", "martial"), weapon("hand-crossbow", "martial", false, true), weapon("heavy-crossbow", "martial"),
  weapon("longbow", "martial"), weapon("musket", "martial"), weapon("pistol", "martial"),
] as const;
...
export const DND5E_GUIDED_CLASS_CHOICE_RULES: Record<"barbarian" | "fighter" | "monk" | "rogue", GuidedDnd5eClassChoiceRules> = {
  ...
  monk: {
    skillIds: ["acrobatics", "athletics", "history", "insight", "religion", "stealth"],
    skillCount: 2,
    weaponMasteryIds: [],
  ...
  rogue: {
    skillIds: ["acrobatics", "athletics", "deception", "insight", "intimidation", "investigation", "perception", "persuasion", "sleight-of-hand", "stealth"],
    skillCount: 4,
...
function weapon(id: string, category: "simple" | "martial", finesse = false, light = false): Dnd5eWeaponChoiceOption {
  return { id, label: labelId(id), category, finesse, light };
}
